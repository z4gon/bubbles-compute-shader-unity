...
namespace Bubbles
{
    ...
    public class BubblesComputeShaderLink : MonoBehaviour
    {
        private const int TEXTURE_RESOLUTION = 256;
        private const int THREAD_GROUP_COUNT = 1;

        public ComputeShader computeShader;
        public KernelName KernelName = KernelName.DrawCircle;
        ...
        void Start()
        {
            ...
            DispatchShader(THREAD_GROUP_COUNT, THREAD_GROUP_COUNT);
        }
